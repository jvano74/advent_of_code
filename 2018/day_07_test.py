...
class WorkShop:
    ...
    def advance_time(self):
        ...
        for worker, work_job in self.workers_working[self.work_time]:
            ...
            self.work_completed.append(work_job)  # if multiple workers finish at same time could sort
        ...
        for now_maybe_possible in self.blocked_work:
            if all((required in self.work_completed) for required in self.pre_req_graph[now_maybe_possible]):
...
def test_find_time():
    ...
    assert workshop.find_time() == ('62:B' + '129:G' + '199:J' + '206:Q' + '210:U' + '214:Y' + '262:C' +
                                    '273:N' + '289:O' + '342:I' + '345:L' + '375:Z' + '408:F' + '415:M' +
                                    '480:E' + '488:T' + '549:A' + '559:K' + '613:D' + '628:S' + '704:P' +
                                    '786:V' + '788:X' + '866:R' + '934:H' + '1017:W', 1017)
    # 1911 was too high
