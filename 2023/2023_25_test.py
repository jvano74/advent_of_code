...
class Puzzle:
    ...
    As you reach the edge of Snow Island, you can already tell from way up here
    that everyone will have a white Christmas this year after all.

    Congratulations! You've finished every puzzle in Advent of Code 2023! I hope
...
with open(Path(__file__).parent / "2023_25_input.txt") as fp:
