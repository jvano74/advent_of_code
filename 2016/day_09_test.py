class Puzzle:
    ...
    subsequent 10 characters and repeat them 2 times. Then, continue reading the file after the repeated
    ...
    - X(8x2)(3x3)ABCY becomes XABCABCABCABCABCABCY, because the decompressed data from the (8x2)
      marker is then further decompressed, thus triggering the (3x3) marker twice for a total of
      six ABC sequences.
...
SAMPLE = ['ADVENT', 'A(1x5)BC', '(3x3)XYZ', 'A(2x2)BCD(2x2)EFG', '(6x1)(1x3)A', 'X(8x2)(3x3)ABCY']
SAMPLE_RESULT = ['ADVENT', 'ABBBBBC', 'XYZXYZXYZ', 'ABCBCDEFEFG', '(1x3)A', 'X(3x3)ABC(3x3)ABCY']
...
def parse_repeat(remaining_string):
    ...
    #  abcd(29x12)(20x12)(13x14)(7x10)(1x12)Anxyz + 0
    #      (29x12)(20x12)(13x14)(7x10)(1x12)Anxyz + 4
    #    [ (20x12)(13x14)(7x10)(1x12)An ] 12 + 'xyz' + 4
    #    [       [(13x14)(7x10)(1x12)A ] 12 + 'n' ] 12 + 'xyz' + 4
    #    [       [      [(7x10)(1x12)A ] 14 + '' ] 12 + 'n' ] 12 + 'xyz' + 4
    #    [       [      [     [(1x12)A ] 10 + '' ] 14 + '' ] 12 + 'n' ] 12 + 'xyz' + 4
    #    [       [      [     [    [ A ] 12 + '' ] 10 + '' ] 14 + '' ] 12 + 'n' ] 12 + 'xyz' + 4
    #
    #    [       [      [     [    [ 1 ] 12 + '' ] 10 + '' ] 14 + '' ] 12 + 'n' ] 12 + 'xyz' + 4
    #    [       [      [     [        1*12 + 0  ] 10 + '' ] 14 + '' ] 12 + 'n' ] 12 + 'xyz' + 4
    #    [       [      [                       12*10 + 0  ] 14 + '' ] 12 + 'n' ] 12 + 'xyz' + 4
    #    [       [                                     120 * 14 + 0  ] 12 + 'n' ] 12 + 'xyz' + 4
    #    [                                                      1680 * 12 + 1   ] 12 + 'xyz' + 4
    #                                                                     20161 * 12 + 3     + 4
    #                                                                                     241927
...
def test_parse_repeat():
    ...
    assert parse_repeat('(27x12)(20x12)(13x14)(7x10)(1x12)A') == ('', '(20x12)(13x14)(7x10)(1x12)A', 12)
